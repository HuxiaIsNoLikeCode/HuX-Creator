...
@ConditionalOnProperty(prefix = "hux.ai.providers.gemini", name = "api-key")
public class GeminiAdapter extends AbstractModelAdapter {

    @Value("${hux.ai.providers.gemini.api-key}")
    private String apiKey;

    @Value("${hux.ai.providers.gemini.base-url:https://generativelanguage.googleapis.com/v1beta/openai}")
    private String baseUrl;

    @Value("${hux.ai.providers.gemini.model:gemini-2.0-flash}")
